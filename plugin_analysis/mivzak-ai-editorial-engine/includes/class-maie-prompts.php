...
2. עבור תוכן חדשותי: הדגש על מה שחדש בתוך חלון הזמן — אירוע, הצהרה, מהלך, החלטה, עדכון מצב. עבור סיפורים מתפתחים (מתחים גיאופוליטיים, מלחמות, חקירות, משברים) — כל פיתוח טרי שהופיע בתוך חלון הזמן הוא חדשות לגיטימיות. אין לבחור כתבת ניתוח ישנה שפורסמה מחדש ללא שינוי ממשי, אך חובה לבחור כל עדכון, פעולה, הצהרה, סנקציה, מינוי, כינוס, תקיפה, עסקה או התפתחות טרייה שיש עליה כיסוי מחלון הזמן.
...
5. החזר דלג רק אם חיפוש הרשת לא מצא שום תוצאה רלוונטית לקטגוריה. אם נמצאו תוצאות רלוונטיות — חובה לבחור את הטובה ביותר, גם אם אינה "דרמטית" במיוחד. עצם קיום הכיסוי העדכני הוא אות לבחור ולכתוב.
...
9. לפרופילי חדשות עם חיפוש רשת מופעל: חובה לבחור נושא אם הרשת הניבה תוצאות. ספק ספין עצמי ואמרות כמו "לא נמצא נושא מתאים" כשיש כיסוי ברשת הן שגיאה חמורה.
PROMPT);
    }
