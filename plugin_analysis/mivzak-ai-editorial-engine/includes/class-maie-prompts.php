...
2. עבור תוכן חדשותי: בחר את הפיתוח הכי עדכני שמצאת. עבור סיפורים מתפתחים (מתחים גיאופוליטיים, מלחמות, חקירות, משברים) — בחר את הידיעה הספציפית החדשה ביותר שפורסמה (הצהרה, פגישה, תקיפה, החלטה, עסקה, עדכון רשמי). אל תבחר כתבת רקע ישנה שאין בה דבר חדש.
3. חובה לאתר לפחות 2 מקורות עצמאיים שמכסים את אותה התפתחות. ציין אותם ב-source_notes.
4. אם יש זיקה לישראל והיא רלוונטית לקטגוריה, תן לכך עדיפות.
5. אם חיפוש הרשת הניב תוצאות רלוונטיות לקטגוריה — חובה לבחור את הטובה ביותר ולהחזיר status='ok'. החזר status='skip' רק אם החיפוש לא הניב שום תוצאה רלוונטית לנושא. אל תחליט בעצמך שאירוע "ישן מדי" — דווח את הגיל המשוער ב-estimated_event_age_hours והמערכת תחליט.
